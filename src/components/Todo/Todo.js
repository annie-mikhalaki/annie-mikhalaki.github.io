...
import {
  ...
  SHOW_COMPLETED,
  SHOW_UNCOMPLETED
} from '../../entities/visibilityFilters'
import {
    sortTasksByTitleASC,
            ...
            <div className={classes.Toolbar}>
                <div className={classes.buttonGroup}>
                    ...
                    <button
                        ...
                        {...((sortOrder === ALPHABETIC_ASC || sortOrder === ALPHABETIC_DESC) && {
                            style: { background: '#d8d7d7' },
                        })}
                    >
                        By title&nbsp;
                        {sortOrder === ALPHABETIC_ASC && <i className="fa-solid fa-arrow-down-a-z"></i>}
                        {sortOrder === ALPHABETIC_DESC && <i className="fa-solid fa-arrow-up-a-z"></i>}
                    </button>
                    <button
                        className={classes.button}
                        onClick={setSortOrderByCreationDate}
                        title="Sort tasks by creation date"
                        {...((sortOrder === CREATION_DATE_ASC || sortOrder === CREATION_DATE_DESC) && {
                            style: { background: '#d8d7d7' },
                        })}
                    >
                        By creation date&nbsp;
                ...
                <div className={classes.buttonGroup}>
                    ...
                    <button className={classes.button + ' ' + classes.error} onClick={onRemoveAll}>
                        Clean all
                    </button>
                </div>
            </div>
