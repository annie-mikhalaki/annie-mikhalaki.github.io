        ...
        <div className={todoItemClasses.join(' ')}>
            <div className={classes.todoItemContent}>
                ...
                <span className={classes.todoItemToolbar}>
                    <i
                        className={`fa-solid fa-circle-check ${classes.checkIcon}`}
                        title={checkIconTitle}
                        onClick={handleCompletedClick}
                    ></i>
                    <i
                        className={`fa-solid fa-pencil ${classes.editIcon}`}
                        title="Edit Task"
                        onClick={handleEditClick}
                    ></i>
                    <i
                        className={`fa-solid fa-trash-can ${classes.removeIcon}`}
                        title="Remove Task"
